...
// indexOf는 해당문자열의 위치(인덱스)를 알려준다.
// 배열에서도 indexOf를 사용하여 값을 찾을 수 있다.
// indexOf 함수로 일치하는 데이터를 찾았다면 인덱스를 반환
//인덱스는 0부터 시작
//일치하는 데이터를 찾지못하면 -1 반환
...
var srh_bt = document.getElementById("search_bt");
...
function search_name() {
    ...
    input.focus(); // 검색 input 태그에 커서 놓기 , 다음 검색을 위해
}
